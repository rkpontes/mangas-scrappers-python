...
- **Single project**: `src/` at repository root, with validation notes in `specs/` or `docs/` when needed
...
- [ ] T010 [US1] Document manual validation steps in specs/[###-feature-name]/quickstart.md
- [ ] T011 [US1] Verify happy path and failure path manually

### Tests for User Story 1 (OPTIONAL - only if explicitly requested)

- [ ] T012 [P] [US1] Add automated test coverage only if required by spec
...
- [ ] T019 [US2] Document manual validation steps
- [ ] T020 [US2] Verify happy path and failure path manually

### Tests for User Story 2 (OPTIONAL - only if explicitly requested)

- [ ] T021 [P] [US2] Add automated test coverage only if required by spec
...
- [ ] T026 [US3] Document manual validation steps
- [ ] T027 [US3] Verify happy path and failure path manually

### Tests for User Story 3 (OPTIONAL - only if explicitly requested)

- [ ] T028 [P] [US3] Add automated test coverage only if required by spec
...
- [ ] TXXX [P] Additional automated tests (only if requested and justified)
...
- Automated tests, when included, MUST be justified by the spec
...
- Manual validation tasks can run after implementation for each story
...
Task: "Document manual validation steps in specs/[###-feature-name]/quickstart.md"
Task: "Verify happy path and failure path manually"
